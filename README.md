...
|___ /core
|   | Menu.py - Exports the Menu class to handle choice inputs/outputs
|   | Task.py - Exports the Task class to hold task data
|   | Tasks_Model.py - Exports the Tasks_model class to manage task CRUD operations
|   | Validator.py - Exports the Validator class to provide standard validation checks
```
...
If your inputs were valid a task id will be automatically generated and the new task will be passed into memory storage.
